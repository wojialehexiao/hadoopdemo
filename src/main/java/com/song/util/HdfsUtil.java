...
/**
 * Created by Duo Nuo on 2018/2/5 0005.
 */
public class HdfsUtil {

	public static String uri = "hdfs://192.168.10.21:8020";
	...
	/**
	 * append something to file dst and add a \n at the end of the string
	 *
	 * @param hdfsFile a full path name, may like '/tmp/test.txt'
	 * @param content string
	 * @return boolean true-success, false-failed
	 * @throws Exception something wrong
	 */
	public static boolean appendLine(String hdfsFile, String content) throws Exception {
		return HdfsUtil.append(hdfsFile,content + "\n");
	}
}
